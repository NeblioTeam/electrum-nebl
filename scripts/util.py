import select, time, electrum_nebl as electrum, Queue
from electrum_nebl import Connection, Interface, SimpleConfig
from electrum_nebl.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'electrum-nebl.bysh.me:50002:s'
