...
from electrum_nebl.keystore import bip39_normalize_passphrase
from electrum_nebl.bitcoin import serialize_xpub
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    #    return self.get_address('Neblio', self.expand_path(derivation))
