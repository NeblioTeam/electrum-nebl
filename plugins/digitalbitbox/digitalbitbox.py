...
try:
    ...
    from electrum_nebl.bitcoin import TYPE_ADDRESS, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_nebl.i18n import _
    from electrum_nebl.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_nebl.util import print_error
