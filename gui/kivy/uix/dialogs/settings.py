...
from electrum_nebl.util import base_units
...
from electrum_nebl import coinchooser
...
#:import _ electrum_nebl_gui.kivy.i18n._
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Neblio amounts.")
                    action: partial(root.unit_dialog, self)
                CardSeparator
                SettingsItem:
                    status: root.fee_status()
                    title: _('Fees') + ': ' + self.status
                    description: _("Fees paid to the Neblio miners.")
