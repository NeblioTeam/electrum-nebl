...
from electrum_nebl_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_nebl.mnemonic import Mnemonic
        from electrum_nebl.old_mnemonic import words as old_wordlist
